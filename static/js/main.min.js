!function (e) {
    ...
    var r = new Swiper(".gallery-thumbs", {
        ...
        watchSlidesProgress: !0,
        navigation: {nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev"}
    }), new Swiper(".gallery-top", {spaceBetween: 0, loop: !0, thumbs: {swiper: r}}), e(".cart-plus-minus"));
    p.prepend('<div class="dec qtybutton">-</div>'), p.append('<div class="inc qtybutton">+</div>'), e(".qtybutton").on("click", function () {
        var s = e(this), i = s.parent().find("input").val();
        if ("+" === s.text()) var n = parseFloat(i) + 1; else if (i > 1) n = parseFloat(i) - 1; else n = 1;
